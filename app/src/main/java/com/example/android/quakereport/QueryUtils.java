    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i= 0; i<earthquakeArray.length();i++){
                JSONObject currentEarthqueake =earthquakeArray.getJSONObject(i);
                JSONObject properties = currentEarthqueake.getJSONObject("properties");

                String magnitude = properties.getString("meg");
